...
class ModelTraining:
    ...
    def logistic_regression_model(self):
        ...
        print("Completed training the logistic model")
    ...
    def Naive_Bayes(self):
        ...
        print("Completed training the Naive Bayes model")
        joblib.dump(nb_model , "NBayes.pkl")
        return nb_model
